    ...
    <section class="content-header ">
        <div class="container-fluid">
            <div class="d-flex justify-content-between">
                <div class="clearfix">
                    <div class="pt-0 pb-0">
                        <h4 class="pd-0 mg-0 text-10">Specialization</h4>
                    </div>
                    <div class="breadcrumb pd-0 mg-0 text-sm">
                        ...
                        <span class="breadcrumb-item active">Specialization</span>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-xs-12 pull-right">
                                    <a href="{{ route('specializations.create') }}" class="btn btn-dark mb-2 ">
                            ...
                            <div class="table-data">
                                <div class="table-responsive">
                                    <table id="dataTableajax" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tbody>
                                            @forelse ($paginated as  $specialization)
                                                <tr>
                                                    <td>
                                                        <div class="custom-control custom-checkbox ml-2">
                                                            <input type="checkbox" class="custom-control-input"
                                                                id="check_box_{{ $specialization->id }}" name="region_ids[]"
                                                                value="{{ $specialization->id }}">
                                                            <label class="custom-control-label"
                                                                for="check_box_{{ $specialization->id }}">
                                                            </label>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="table-actions">
                                                            <a href="{{ url('/specializations', $specialization->id) }}"><i
                                                                    class="fas fa-eye"></i></a>
                                                            <a
                                                                href="{{ route('specializations.edit', $specialization->id) }}"><i
                                                                    class="fas fa-pen"></i></a>
                                                            <a href="#" data-id="{{ $specialization->id }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('table').on('click', '#deleteButton', function(e) {
                ...
                var route = "{{ route('specializations.destroy', ':id') }}".replace(':id', districtId);

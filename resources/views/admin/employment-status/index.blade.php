    ...
    <section class="content-header ">
        <div class="container-fluid">
            <div class="d-flex justify-content-between">
                <div class="clearfix">
                    <div class="pt-0 pb-0">
                        <h4 class="pd-0 mg-0 text-10">Employment Status</h4>
                    </div>
                    <div class="breadcrumb pd-0 mg-0 text-sm">
                        ...
                        <span class="breadcrumb-item active">Employment Status</span>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-xs-12 pull-right">
                                    <a href="{{ route('employment-statuses.create') }}" class="btn btn-dark mb-2 ">
                                        <i class="ik ik-plus"></i>
                                        Add Employment Status</a>
                            ...
                            <div class="table-data">
                                <div class="table-responsive">
                                    <table id="dataTableajax" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tbody>
                                            @forelse ($paginated as  $employment_status)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="table-actions">
                                                            <a
                                                                href="{{ url('/employment-statuses', $employment_status->id) }}"><i
                                                                    class="fas fa-eye"></i></a>
                                                            <a
                                                                href="{{ route('employment-statuses.edit', $employment_status->id) }}"><i
                                                                    class="fas fa-edit"></i></a>
                                                            <a href="#" data-id="{{ $employment_status->id }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('table').on('click', '#deleteButton', function(e) {
                ...
                var route = "{{ route('employment-statuses.destroy', ':id') }}".replace(':id', categoryId);

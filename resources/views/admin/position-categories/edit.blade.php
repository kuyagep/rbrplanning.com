            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3>Edit Position Category</h3>
                    </div>
                    <div class="card-body">
                        <form method="post" class="needs-validation"
                            action="{{ route('position-categories.update', $position_category->id) }}" novalidate
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <input type="hidden" name="id" id="id" value="{{ $position_category->id }}">

                            <div class="form-group row">
                                <label for="name" class="col-sm-3 col-form-label">Position Category</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ old('name', $position_category->name) }}" required>

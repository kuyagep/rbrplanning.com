                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" class="needs-validation"
                                action="{{ route('funding-sources.update', $track->id) }}" novalidate
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-sm-3 col-form-label">Track name</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 text-right">
                                        <a href="{{ route('tracks.index') }}" class="btn btn-secondary"><i

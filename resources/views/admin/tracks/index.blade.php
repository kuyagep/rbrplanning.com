                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-xs-12 pull-right">
                                <a href="{{ route('tracks.create') }}" class="btn btn-dark mb-2 ">
                                    <i class="ik ik-plus"></i>
                                    Add Tracks</a>

                            </div>
                            <div class="col-lg-6 col-xs-12">
                                <form action="{{ route('tracks.index') }}" method="GET" class="form-inline float-right">
                                    @csrf
                        ...
                        <div class="table-data">
                            <div class="table-responsive">
                                <table id="dataTableajax" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        @forelse ($paginated as  $tracks)
                                            <tr>
                                                <td>{{ $tracks->name }}</td>

                                                <td class="text-center">
                                                    <div class="table-actions ">
                                                        <a href="{{ url('/tracks', $tracks->id) }}"><i
                                                                class="ik ik-eye"></i></a>
                                                        <a href="{{ route('tracks.edit', $tracks->id) }}"><i
                                                                class="ik ik-edit-2"></i></a>
                                                        <a href="#" data-id="{{ $tracks->id }}" id="deleteButton"><i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('table').on('click', '#deleteButton', function(e) {
                ...
                var route = "{{ route('tracks.destroy', ':id') }}".replace(':id', trackId);

    ...
    <section class="content-header ">
        <div class="container-fluid">
            <div class="d-flex justify-content-between">
                <div class="clearfix">
                    <div class="pt-0 pb-0">
                        <h4 class="pd-0 mg-0 text-10">unding Sources</h4>
                    </div>
                    <div class="breadcrumb pd-0 mg-0 text-sm">
                        ...
                        <span class="breadcrumb-item active">unding Sources</span>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 col-xs-12 pull-right">
                                    <a href="{{ route('funding-sources.create') }}" class="btn btn-dark mb-2 ">
                                        <i class="ik ik-plus"></i>
                                        Add Funding Sources</a>
                            ...
                            <div class="table-data">
                                <div class="table-responsive">
                                    <table id="dataTableajax" class="table table-striped table-bordered nowrap">
                                        ...
                                        <tbody>
                                            @forelse ($paginated as  $funding_source)
                                                <tr>
                                                    <td>{{ $funding_source->fund_source }}</td>

                                                    <td class="text-center">
                                                        <div class="table-actions">
                                                            <a href="{{ url('/funding-sources', $funding_source->id) }}"><i
                                                                    class="fas fa-eye"></i></a>
                                                            <a
                                                                href="{{ route('funding-sources.edit', $funding_source->id) }}"><i
                                                                    class="fas fa-pencil-alt"></i></a>
                                                            <a href="#" data-id="{{ $funding_source->id }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('table').on('click', '#deleteButton', function(e) {
                ...
                var route = "{{ route('funding-sources.destroy', ':id') }}".replace(':id', categoryId);

                Swal.fire({
                    title: 'Are you sure?',
                    text: "You want to delete this funding source?",
                    icon: 'warning',

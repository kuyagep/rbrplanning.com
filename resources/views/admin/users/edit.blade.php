                            ...
                            <div class="row">
                                <div class="col-12 mb-4">
                                    <form action="{{ route('reset.password.user') }}" method="post">
                                        ...
                                        <button class="btn btn-sm btn-danger float-right" type="submit"><i
                                ...
                                <div class="col-12">
                                    <form method="post" action="{{ route('users.update', $user->id) }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select class="form-control form-control-sm" id="school_id"
                                                    name="school_id">
                                                    <option value="">Choose...</option>
                                        ...
                                        <a href="{{ route('users.index') }}"
                                            class="btn  btn-sm btn-secondary float-right"><i
                                                class="ik ik-chevron-left"></i>Back</a>
                                        <button type="submit" class="btn  btn-sm btn-primary mr-2 float-right"><i
                                                class="ik ik-save"></i>
                                            Update</button>
                                    </form>
                                </div>

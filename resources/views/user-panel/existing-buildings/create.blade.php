                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="no_of_tls" type="number"
                                                    class="form-control @error('no_of_tls') is-invalid @enderror"
                                                    name="no_of_tls" value="{{ old('no_of_tls') }}" required>
                                                @error('no_of_tls')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="minor_repair_classrooms" type="number"
                                                    ...
                                                    name="minor_repair_classrooms"
                                                    value="{{ old('minor_repair_classrooms') }}" required>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="major_repair_classrooms" type="number"
                                                    ...
                                                    name="major_repair_classrooms"
                                                    value="{{ old('major_repair_classrooms') }}" required>

    ...
    i(a).ready(function () {
        ...
        new PerfectScrollbar(o, {
            ...
            s.on("click", ".navigation-main .nav-item a", function () {
                ...
                if (e.hasClass("has-sub") && e.hasClass("open")) n(e);
                else {
                    if (
                        (e.hasClass("has-sub") &&
                            (function (e, a) {
                                var n = e.children(".submenu-content"),
                                    t = n
                                        .children(".menu-item")
                                        .addClass("is-hidden");
                                e.addClass("open"),
            ...
            t
                ...
                .on("mouseleave", function (e) {
                    if (l.hasClass("nav-collapsed")) {
                        ...
                        var a = i(".navigation-main .nav-item.open"),
                            n = a.children(".submenu-content");
                        a.addClass("nav-collapsed-open"),
                            n.show().slideUp(300, function () {
                                i(this).css("display", "");
                            }),
                            a.removeClass("open");
                    }
            ...
            i("#checkbox_select_all").on("click", function () {
                for (
                    var e = a.getElementsByName("item_checkbox"), n = 0;
                    n < e.length;
                    n++
                )
                    "checkbox" == e[n].type && (e[n].checked = !0),
            ...
            i("#checkbox_deselect_all").on("click", function () {
                for (
                    ...
                    "checkbox" == e[n].type && (e[n].checked = !1),
            ...
            "undefined" != typeof screenfull &&
                screenfull.enabled &&
                i(a).on(screenfull.raw.fullscreenchange, function () {
            ...
            i(".minimize-widget").on("click", function () {
                var e = i(this),
                    a = i(e.parents(".widget"));
                i(a).children(".widget-body").slideToggle(),
            ...
            i(".card-header-right .minimize-card").on("click", function () {
                var e = i(this),
                    a = i(e.parents(".card"));
                i(a).children(".card-body").slideToggle(),
                    i(this).toggleClass("ik-minus").fadeIn("slow"),
                    i(this).toggleClass("ik-plus").fadeIn("slow");
            }),
            ...
            i(".search-close").on("click", function () {
                i(".header-search .form-control").animate({ width: "0" }),
                    setTimeout(function () {
        ...
        if (c.length) {
            c.find(".chat-list").each(function (e) {
                ...
                $(this)
                    .find(".list-group a")
                    .on("click", function () {
                        a.find(".list-group a.active").removeClass("active"),
                        ...
                        if (e.length) {
                            ...
                            (i[0].scrollTop = i[0].scrollHeight),
                                i[0].classList.contains("scrollbar-enabled") &&
            ...
            (c = $(".chat-panel")).length &&
                ...
                c.find(".minimize").on("click", function () {
                    c
                        .find(".card-block")
                        .attr("hidden", !c.find(".card-block").attr("hidden")),
